...
const cryptoBalance = document.getElementById("main-balance");
...
const registerDate = document.getElementById("register-time");
...
function renderUserData(userData) {
  ...
  investmentBalance.innerHTML = `$${Math.floor(
  ...
  registerDate.innerHTML = `${userData.Registered_Date}`;
